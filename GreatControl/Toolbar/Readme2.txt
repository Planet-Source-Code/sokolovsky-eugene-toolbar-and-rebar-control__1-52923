***********************************************************************
vbAccelerator CoolMenu Toolbar and Rebar Control 
Demonstration (vbaltbd.zip)
...
----------------------------------------------------------
This control provides a small and light (160k) all VB replacement for the 
...
**********************************************************************
Distribution notice:
You are free to distribute vbaltbd.zip in it's original state to any
...
If you wish to distribute vbaltbd.zip by any other means (i.e. if 
